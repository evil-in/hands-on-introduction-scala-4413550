...
class EtlSpec extends AnyFreeSpec with Matchers {
  "etl" - {
    "transforms a text file by making all the text lowercase and saving this to a new file" in {
      val input = "C:/Users/preet/Documents/Scala/Learning/hands-on-introduction-scala-4413550/src/test/scala/resources/input.txt"
      val output = "C:/Users/preet/Documents/Scala/Learning/hands-on-introduction-scala-4413550/src/test/scala/resources/output.txt"
